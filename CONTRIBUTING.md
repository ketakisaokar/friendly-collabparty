...
*This is being copied from St. Jude Data Science and AI COP repo*
...
To learn more about why we recommend creating a `CONTRIBUTING.md` file, please read the [Contributors and Communication Pathways chapter](https://book.the-turing-way.org/project-design/project-repo/project-repo-contributors.html) in *The Turing Way* Guide for Project Design.

<!--delete sentences above this line when reusing this repository-->

The **Reproducible Project Template** repository, originally developed under ***[The Turing Way](https://github.com/alan-turing-institute/the-turing-way)*, demonstrates the practical integration of reproducibility practices on the collaborative or shared online repository**.
...
For any organisation related queries or concerns, you can directly reach out to contact person listed in [README](./README.md).
